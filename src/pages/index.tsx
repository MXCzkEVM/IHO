...
function randomItemImageVariants(yRange: [number, number] = [-10, 10], delayRange: [number, number] = [0, 1]): Variants {
  const getRandomValue = (range: [number, number]) => Math.random() * (range[1] - range[0]) + range[0]

  return {
    animate: {
      y: [getRandomValue(yRange), getRandomValue(yRange)],
      transition: {
        ease: 'easeInOut',
        repeat: Infinity,
        repeatType: 'reverse',
        duration: 1,
        delay: getRandomValue(delayRange),
      },
    },
  }
}
...
function Page() {
  return (
    <div className="text-auto flex-col">
...
function Hero() {
  return (
    <motion.div variants={opacityVariants} initial="hidden" whileInView="visible" className="relative z1 mx-37.5em" md="mt-30px" lg="mt-62.5em">
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* line 1 */}
        <motion.path variants={lineVariants} opacity="0.3" d="M1384.49 0C1374.66 54.1773 1374.59 168.992 1453 194.833C1531.4 220.674 1573.01 276.014 1584.01 300.453" stroke="white" stroke-width="12" />

        {/* line 2 */}
        <motion.path variants={lineVariants} opacity="0.3" d="M1627.64 333.198C1689.24 397.188 1792.68 552.572 1713.69 662.187C1634.69 771.803 1509.15 781.603 1456.25 772.802" stroke="white" stroke-width="12" />
        {/* line 3 */}
        <motion.path variants={lineVariants} opacity="0.3" d="M1567 653.006C1522.83 686.558 1404.6 751.842 1285 744.558C1165.4 737.274 1129.5 789.744 1102.5 854.32C1080.33 906.756 1079.9 1002.62 1255.5 966.611C1431.1 930.597 1548.67 1032.2 1585.5 1087.5" stroke="white" stroke-width="12" />
        ...
        >
          ...
          {/* image phone */}
          <motion.rect variants={randomItemImageVariants([-5, 5])} animate="animate" x="1233" y="236" width="490" height="690" fill="url(#pattern10_3994_80)" />
          {/* image watch */}
          <motion.rect variants={randomItemImageVariants()} animate="animate" x="1517" y="277.451" width="176" height="176" transform="rotate(-45 1517 277.451)" fill="url(#pattern11_3994_80)" />
          {/* image camera */}
          <motion.rect variants={randomItemImageVariants()} animate="animate" x="1215" y="255" width="209" height="209" fill="url(#pattern12_3994_80)" />
          {/* image ring */}
          <motion.rect variants={randomItemImageVariants()} animate="animate" x="1496" y="586.894" width="236.304" height="236.304" transform="rotate(-40 1496 586.894)" fill="url(#pattern13_3994_80)" />
          {/* image speak */}
          <motion.rect variants={randomItemImageVariants()} animate="animate" x="1200.02" y="591.499" width="175.693" height="175.693" transform="rotate(11 1200.02 591.499)" fill="url(#pattern15_3994_80)" />
          {/* image projection */}
          <motion.rect variants={randomItemImageVariants()} animate="animate" x="1451" y="792" width="211" height="211" fill="url(#pattern14_3994_80)" />
        </motion.g>
        {/* image astronaut */}
        <motion.g variants={opacityVariants} initial="hidden" whileInView="visible">
        ...
        {/* line 4 */}
        <motion.path variants={lineVariants} opacity="0.3" d="M1516.5 1535.96C1490 1533.12 1414.5 1514.96 1324.5 1464.96C1212 1402.46 1061 1344.5 978 1341" stroke="white" stroke-width="12" />
        ...
        {/* line 6 */}
        <motion.path variants={lineVariants} opacity="0.3" d="M489.5 1916C489.667 1958.33 515.3 2043 616.5 2043C743 2043 825.5 1985.5 825.5 2096.5C825.5 2207.5 941.5 2139 1237.5 2139" stroke="white" stroke-width="12" />
        ...
        {/* line 7 */}
        <motion.path variants={lineVariants} opacity="0.3" d="M1584 2190C1585.17 2220 1604.8 2280 1674 2280C1743.2 2280 1762.17 2339.33 1763 2369C1761.83 2397.67 1777.4 2455 1849 2455C1920.6 2455 2032.5 2538 2079.5 2579.5" stroke="white" stroke-width="12" />
        <motion.path variants={lineVariants} opacity="0.3" d="M2053 3233.5C2000.33 3233.5 1895 3259.4 1895 3363C1895 3466.6 1812.67 3488.5 1771.5 3486.5H1582.5" stroke="white" stroke-width="12" />
...
function Accordions() {
  return (
    <motion.div
      ...
      initial="hidden"
      whileInView="visible"
      className="mx-37.5em py-20em lt-md:mx-6em text-auto-clamp "
    >
      <Accordion type="single" collapsible className="w-full">
        <AccordionItem value="item-1">
          <AccordionTrigger className="text-6em">
            What is moonchain IHO?
          </AccordionTrigger>
          <AccordionContent className="text-4em">
        ...
        <AccordionItem value="item-2">
          <AccordionTrigger className="text-6em">How do i lock moonchain to get my free hardware?</AccordionTrigger>
          <AccordionContent className="text-4em">
            Simply visit
            {' '}
        ...
        <AccordionItem value="item-3">
          <AccordionTrigger className="text-6em">Why would you give away free mining hardware?</AccordionTrigger>
          <AccordionContent className="text-4em">
        ...
        <AccordionItem value="item-4">
          <AccordionTrigger className="text-6em">How should i choose the right hardware for me?</AccordionTrigger>
          <AccordionContent className="text-4em">
        ...
        <AccordionItem value="item-5">
          <AccordionTrigger className="text-6em">How do the locks work on my wallet?</AccordionTrigger>
          <AccordionContent className="text-4em">
...
function Footer() {
  return (
    <footer className="py-5 border-t mt-20em relative z1">
      <span className="text-3.5 mx-37.5em lt-md:mx-6em">
        © 2025
        {' '}
