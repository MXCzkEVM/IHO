...
export function Accordions() {
  return (
    <motion.div
      ...
      initial="hidden"
      whileInView="visible"
      className="mx-37.5 py-20 text-auto-clamp"
      lt-lg="ml-18em mr-28em"
    >
      <Accordion type="single" collapsible className="w-full">
        <AccordionItem value="item-1">
          <AccordionTrigger lt-lg="pt-7">
        ...
        <AccordionItem value="item-2">
          <AccordionTrigger lt-lg="pt-7">How do i lock moonchain to get my free hardware?</AccordionTrigger>
          <AccordionContent>
            Simply visit
            {' '}
        ...
        <AccordionItem value="item-3">
          <AccordionTrigger lt-lg="pt-7">Why would you give away free mining hardware?</AccordionTrigger>
          <AccordionContent>
        ...
        <AccordionItem value="item-4">
          <AccordionTrigger lt-lg="pt-7">How should i choose the right hardware for me?</AccordionTrigger>
          <AccordionContent>
        ...
        <AccordionItem value="item-5">
          <AccordionTrigger lt-lg="pt-7">How do the locks work on my wallet?</AccordionTrigger>
          <AccordionContent>
